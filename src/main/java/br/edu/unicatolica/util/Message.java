...
public class Message implements Serializable{
	 ...
	 * @param parametros
	 *            par�metros para mensagem de erro
	 */
	 ...
	 * 
	 * @param componetId
	 *            ID do componente ao qual a mensagem ser� associada
	 * @param summaryKey
	 *            Chave do detalhe da mensagem de erro
	 * @param parametros
	 *            parâmetros para mensagem de erro
	...
	public static void addInfoMessageWithFlash(String summary, String detail) {
